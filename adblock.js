    ...
    (function(b, a) {
        ...
        e.prototype = {
            ...
            displayMessage: function(g) {
                ...
                f.insert('<p>ãä İÖáß Şã ÈÊÚØíá ãÖÇÏ ÇáÅÚáÇäÇÊ<br/><br/><img border="0" src="https://image.ibb.co/fD3Cuc/adblock.png" /><br/><br/>åĞÇ ÇáãæŞÚ íŞæã Úáì æÌæÏ ÇáÅÚáÇäÇÊ<br/>ãä İÖáß Şã ÈÊÚØíá ãÖÇÏ ÇáÅÚáÇäÇÊ ÍÊì ÊÏÚãäÇ<a href="JavaScript:window.location.reload()">ÊÍÏíË ÇáÕİÍÉ</a></p>', "h237");
